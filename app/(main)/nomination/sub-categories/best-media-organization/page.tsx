            ...
            <div key={index} className="bg-[#191307] rounded-3xl overflow-hidden shadow-lg transition-transform hover:scale-105 flex flex-col p-6 w-full h-full">
              ...
              <div className="flex-grow flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-3 mt-auto">
                  <button
                    onClick={() => router.push(`/nominees?category=${encodeURIComponent("The Overall Best Media Organization in Nigeria with Outstanding Education Focus")}&subcategory=${encodeURIComponent(category.title)}`)}
